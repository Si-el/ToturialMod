package net.siel.toturialmod.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(ToturialMod.MOD_ID);
    ...
    public static final DeferredBlock<Block> TOPAZ_DEEPSLATE_ORE = registerBlock("topaz_deepslate_ore",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(3.2f).requiresCorrectToolForDrops().sound(SoundType.DEEPSLATE)));
