...
public class ModCreativeModeTabs {
    ...
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TAB =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, ToturialMod.MOD_ID);
    ...
    public static final Supplier<CreativeModeTab> TOTURIALMOD_ITEM_TAB = CREATIVE_MODE_TAB.register("toturialmod_items_tab",
            () -> CreativeModeTab.builder()
                    .icon(()-> new ItemStack(ModItems.TOPAZ.get()))
                    .title(Component.translatable("creativetab.toturialmod.toturialmod_items"))
                    .displayItems((itemDisplayParameters, output) -> {
                        output.accept(ModItems.TOPAZ);
                        output.accept(ModItems.RAW_TOPAZ);
                    }).build());

        public static final Supplier<CreativeModeTab> TOTURIALMOD_BLOCK_TAB = CREATIVE_MODE_TAB.register("toturialmod_blocks_tab",
            () -> CreativeModeTab.builder()
                    .icon(()-> new ItemStack(ModBlocks.TOPAZ_BLOCK.get()))
                    // here we make it appear AFTER the items tab
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(ToturialMod.MOD_ID, "toturialmod_items_tab"))
                    .title(Component.translatable("creativetab.toturialmod.toturialmod_blocks"))
                    .displayItems((itemDisplayParameters, output) -> {
